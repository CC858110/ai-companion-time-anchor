...
<p align="center"><strong>【手机第三方应用（operit / rikka 类）请绕路，给你们磕一个球球了；这个是电脑端的，谢谢谢谢】</strong></p>

> **当前版本：v2.0.1 — UTF-8 时间词提醒修复。** 本地 Codex 与 Claude Code 是主打版本。
...
---
【备注：该项目实测，opus5会出现因模型幻觉导致疯狂看表的情况，不是项目的问题，纯属opus5模型的锅】
